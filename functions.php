...
function gt_setup()
{
    ...
    wp_enqueue_style('style', get_stylesheet_uri()); // queues style.css
    wp_enqueue_script("main", get_theme_file_uri('/js/main.js'), NULL, '1.0.0', true); // queues custom javascript
}
