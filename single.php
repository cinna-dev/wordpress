...
<div id="post-container">
    <section id="blogpost" >
        ...
        <div id="comments-section">
            ...
            $fields   =  array(
                'author' => 
                            '<input placeholder="Name" id="author" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30" maxlength="245"' . $aria_req . $html_req . ' /></p>',
                'email'  => 
            ...
            $args = array(
                ...
                'comment_notes_before' => '<p class="comment-notes">Yuur email address will not be published. All fields are required)</p>'
            );
