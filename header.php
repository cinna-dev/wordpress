...
<body>
    ...
    <nav>
        ...
        <ul>
            ...
            <li><a href="<?= site_url('/blog'); ?>"  <?php if(get_post_type() === 'post') echo 'class="active"' ?>>Blog</a></li>
            <li><a href="<?= site_url('/projects'); ?>"  <?php if(get_post_type() === 'project') echo 'class="active"' ?> >Projects</a></li>
